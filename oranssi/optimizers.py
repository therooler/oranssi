...
from oranssi.opt_tools import SquaredLieAlgebraLayer, StochasticLieAlgebraLayer, \
    LocalLieAlgebraLayer, LieAlgebraLayer, SquaredLieAlgebraLayer_v2, SU8_AlgebraLayer
...
def adaptive_vqe_su_lie_optimizer(circuit, params: List, observables: List,
    ...
    layer = SquaredLieAlgebraLayer_v2(circuit_state_from_unitary_qnode,
                                      circuit_observable_from_unitary_qnode, observables, nqubits,
                                      **kwargs)
